...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    Provider.of<HomescreenProvider>(context, listen: false).setNotesBox(notesBox);
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle:
              Provider.of<HomescreenProvider>(context).isMultiSelection
                  ? false
                  : true,
          leading: Consumer<HomescreenProvider>(builder: (context, provider, child) {
              ...
              builder: (context, provider, _) {
                return Visibility(
                    ...
                    child: IconButton(
                        ...
                        icon: Icon(
                          Icons.select_all,
                          color: provider.selectedItem.length == provider.notesBox.length
                              ? Colors.black
                              : Colors.white,
                        )));
              },
        ...
        body: ValueListenableBuilder<Box<NotesModel>>(
          ...
          builder: (context, box, _) {
            ...
            return data.isEmpty ? EmptyHomeScreen() : ListView.builder(
                          ...
                          Consumer<HomescreenProvider>(
                            builder: (context, provider, _) {
                              return Visibility(
                                visible: provider.isMultiSelection,
                                child: Icon(
                                  provider.selectedItem.contains(data[index])
                                      ? Icons.check_circle
